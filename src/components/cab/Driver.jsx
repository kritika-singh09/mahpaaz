...
// // // //         // Note: The update API uses /api/drivers/{id}
// // // //         response = await fetch(`${API_BASE_URL}/drivers/${editingDriver._id}`, {
// // // //           method: 'PUT',
...
// // // //       } else {
// // // //         // Add new driver
// // // //         // Note: The add API uses /api/driver/add
// // // //         response = await fetch(`${API_BASE_URL}/driver/add`, {
// // // //           method: 'POST',
// // // //           headers: { 'Content-Type': 'application/json' },
// // // //           body: JSON.stringify(driverData),
// // // //         });
...
// // // //       if (!response.ok) {
// // // //         const errorData = await response.json();
// // // //         throw new Error(errorData.message || `Failed to ${editingDriver ? 'update' : 'add'} driver.`);
// // // //       }
...
// // // //                 ) : (
// // // //                   <tr>
// // // //                     <td colSpan="7" className="px-4 py-4 text-center text-sm text-gray-500">No drivers found.</td>
// // // //                   </tr>
// // // //                 )}
// // // //               </tbody>
// // // //             </table>
...
// // // //                 {/* Driver Photo URL */}
// // // //                 <div className="md:col-span-2">
// // // //                   <label htmlFor="driverPhotoUrl" className="block text-sm font-medium text-gray-700 mb-1">Driver Photo URL</label>
// // // //                   <input
// // // //                     type="text"
// // // //                     id="driverPhotoUrl"
// // // //                     name="driverPhotoUrl"
...
// //           <div
// //             id="driver-form-modal-overlay" // Added ID for click detection
// //             className="fixed inset-0 bg-gray-600 bg-opacity-75 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 z-50"
// //             onClick={handleModalClick} // Added onClick handler
// //           >
// //             <style>
// //               {`
...
// //               `}
// //             </style>
// //             <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] bg-black/40 backdrop-blur-xs overflow-y-auto transform scale-95 animate-fade-in hide-scrollbar">
