...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      isDropdown: true,
      children: [
        { label: "Resturant", path: "/resturant", icon: UserRound },
        { label: "Category", path: "/resturant/category", icon: ShoppingCart },
        // { label: "Orders", path: "/resturant/orders", icon: ShoppingCart },
        // { label: "Menu", path: "/resturant/menu", icon: ShoppingCart },
        { label: "Bookings", path: "/resturant/bookings", icon: ShoppingCart },
        // { label: "Table", path: "/resturant/table", icon: ShoppingCart },
      ],
    },
